...
<head>
    ...
    <link rel="stylesheet" href="menu_loggedin_style.css" />
              ...
              <div class="details">
                <div class="details-sub">
                  ...
                  <p>A classic Italian creamy pasta. Bacon, mushrooms, and onions are cooked together with a creamy
                    sauce.</p>
                    <div class="menu-order-button"><a href="cart.php?productname=Bacon Carbonara&productprice=159"><button>Add to Cart</button></a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="crab-rangoon">
              ...
              <div class="details">
                <div class="details-sub">
                  ...
                  <div class="menu-order-button"><a href="cart.php?productname=Crab Rangoon&productprice=139"><button>Add to Cart</button></a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="cheesy-spagh">
              ...
              <div class="details">
                <div class="details-sub">
                  ...
                  <div class="menu-order-button"><a href="cart.php?productname=Cheese Spaghetti&productprice=149"><button>Add to Cart</button></a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="loco-moco">
              ...
              <div class="details">
                <div class="details-sub">
                  ...
                  <div class="menu-order-button"><a href="cart.php?productname=Loco Moco&productprice=120"><button>Add to Cart</button></a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="nachos">
              ...
              <div class="details">
                <div class="details-sub">
                  ...
                  <div class="menu-order-button"><a href="cart.php?productname=Nachos&productprice=149"><button>Add to Cart</button></a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="beef-noodles">
              ...
              <div class="details">
                <div class="details-sub">
                  ...
                  <div class="menu-order-button"><a href="cart.php?productname=Mongolian Beef Noodles&productprice=159"><button>Add to Cart</button></a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="fish">
              ...
              <div class="details">
                <div class="details-sub">
                  ...
                  <div class="menu-order-button"><a href="cart.php?productname=Sweet & Sour Fish&productprice=179"><button>Add to Cart</button></a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="burger-steak">
              ...
              <div class="details">
                <div class="details-sub">
                  ...
                  <div class="menu-order-button"><a href="cart.php?productname=Burger Steak&productprice=109"><button>Add to Cart</button></a></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="details">
                <div class="details-sub">
                  ...
                  <h5 class="price">
                    ₱149</h5>
                  <p>Mexican twist: oven-baked potatoes replace tortilla chips.</p>
                  <div class="menu-order-button"><a href="cart.php?productname=Chicken Wings&productprice=149"><button>Add to Cart</button></a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="milktea">
              ...
              <div class="details">
                <div class="details-sub">
                  ...
                  <br>
                  <div class="menu-order-button"><a href="cart.php?productname=Milktea&productprice=149"><button>Add to Cart</button></a></div>
                </div>
              </div>
            </div>
          </div>
